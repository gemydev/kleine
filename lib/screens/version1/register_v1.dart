...
class RegisterV1 extends StatefulWidget {
  @override
  _RegisterV1State createState() => _RegisterV1State();
}

class _RegisterV1State extends State<RegisterV1> {
  @override
  Widget build(BuildContext context) {
    return InfoWidget(
      returnedWidget: (context, deviceInfo) {
        return Stack(
          children: [
            Image.asset("assets/images/intro_background.png", fit: BoxFit.cover,
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: ListView(
                        ...
                        children: [
                          Container(
                            height: deviceInfo.screenHeight * 0.39,
                            child: Column(
